...
<head>
    ...
    <link 	rel="stylesheet" href="<?= ROOT ?>css/mobile.css" media="screen and (orientation: portrait) or (orientation: landscape) or (max-device-width: 480px)" />
    <link 	rel="stylesheet" href="<?= ROOT ?>css/mobile.css" media="handheld" />
    ...
    <script type="text/javascript" src="<?= ROOT ?>js/jquery.outside-events.js"></script>
    <script type="text/javascript" src="<?= ROOT ?>js/codeslide.js"></script>
    <script type="text/javascript" src="<?= ROOT ?>js/functions.js?4"></script>
    
    <!-- jQuery SB Plugin -->
    <link   rel="stylesheet" 	   href="css/jquery.sb.css" />
    <script type="text/javascript" src="<?= ROOT ?>js/jquery.sb.min.js"></script>
    
    <!-- jQuery TipTip Plugin -->
    <link	rel="stylesheet" 	   href="css/jquery.tiptip.css" />
    <script type="text/javascript" src="<?= ROOT ?>js/jquery.tiptip.min.js"></script>
...
<script type="text/javascript" src="<?= ROOT ?>js/tiptip.js"></script>
