...
;(function($, window, undefined){
	...
	$(document).ready(function()
	{
		...
		{
			$('.select2, select[multiple="multiple"]').each(function(i, el)
			{
				var $this = $(el),
					opts = {
		...
		$('form.newsletter-send-form').on('submit', function (e) {
			if (!confirm('Are you sure you want to send the newsletter? The action CANNOT be undone!')) {
				e.preventDefault();
			}
		});
