...
core::$DOMAIN     	= "autoservicehaarlem.nl.testbyte.nl";
...
$p->addField("Link",	"link",	"link",								"!required",	"300px");
...
$p->addField("Video",	"video",	"text",	"", "450px");
...
$p->addField("Kenteken","car",	"link_select",		"",	"150px",true,"cars|voertuignr|kenteken merk model|kenteken ASC");	
$p->addField("NAP pdf",	"file",	"file|1|nap|pdf",	"",	"400px");
...
/*
	...
	edit type,				text
							bool									this shows a toggleable tick or cross whether it's on 1 or 0 for boolean values
