...
$car_nr = sql::escape($_POST['car']);

if(sql::exists("cars",array("voertuignr"=>$car_nr,"active"=>1)))
	list($car) = sql::fetch("array","cars","WHERE `voertuignr` = '".$car_nr."'");
else
...
<div class="detail_center">
	...
	<div class="nav">
		...
		<a class="left ajax_link" href="detail" data-green="<?= $prev[milieu_bewust] ?>" data-car="<?= $prev[voertuignr] ?>">vorige</a>		
		<a href="search" class="ajax_link">overzicht</a>		
		<a class="right ajax_link" href="detail" data-green="<?= $next[milieu_bewust] ?>" data-car="<?= $next[voertuignr] ?>">volgende</a>
