...
define(ROOT,		  		        'http://www.autototaalhaarlem.nl/m/');
define(COOKIE_DOMAIN,		        '/');
define(CODECREATORS,                $_SERVER['REMOTE_ADDR'] == '80.113.7.74');
 
mobile_core::$favicon 				= 'favicon.ico';
 
mobile_core::$metatitle				= 'Auto Totaal Haarlem';
mobile_core::$metadesc				= 'Auto Totaal Haarlem. Leverancier van jonge occasions , waarvan wij er altijd 150 op voorraad hebben. De scherpste prijzen, Service en kwaliteit.';
mobile_core::$metakeys				= 'Auto Totaal Haarlem, milieubewust, milieubewust rijden, groen en verantwoord, zorgeloos rijden, service en zekerheid, kwaliteit, scherpe prijzen,  zijlweg 294, haarlem';
 
mobile_core::$languages				= array('nl');
mobile_core::$default_lang			= 'nl';
 
mobile_core::$default_page			= array('slug','zoeken'); // default page, table field then value

mobile_core::$social[facebook]		= 'http://www.facebook.com/autototaalhaarlem';
...
mobile_core::$mail_name            = 'Auto Totaal Haarlem';
mobile_core::$mail_from            = 'info@autototaalhaarlem.nl';
mobile_core::$mail_reply           = 'info@autototaalhaarlem.nl';
